<?php 
  ...
  <body><center>
    ...
    <hr>
      <h2 style="color:0462B5"><u> Binance Coin </u></h2>
      <!-- TradingView Widget BEGIN -->
<div class="tradingview-widget-container">
  <div id="tradingview_a0fc2"></div>
  <div class="tradingview-widget-copyright">TradingView\'den <a href="https://tr.tradingview.com/symbols/BNBUSDT/?exchange=BINANCE" rel="noopener" target="_blank"><span class="blue-text">BNBUSDT Grafiği</span></a></div>
  ...
  "container_id": "tradingview_a0fc2"
}
  );
  </script>
</div>
