<?php 
	...
	<body><center>
		...
		<hr>
			<h2 style="color:0462B5"><u> Tether  </u></h2>
			<!-- TradingView Widget BEGIN -->
<div class="tradingview-widget-container">
  <div id="tradingview_ed68b"></div>
  <div class="tradingview-widget-copyright">TradingView\'den <a href="https://tr.tradingview.com/symbols/USDTTRY/?exchange=BINANCE" rel="noopener" target="_blank"><span class="blue-text">USDTTRY Grafiği</span></a></div>
  ...
  "container_id": "tradingview_ed68b"
}
  );
  </script>
</div>
